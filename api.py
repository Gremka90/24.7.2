...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str, age: str, pet_photo: str):
        data = MultipartEncoder(
            fields={
                ...
                'age': age,
                'pet_photo': (pet_photo, open(pet_photo, 'rb'), 'jpg')
            })
        headers = {
            'auth_key': auth_key['key'],
    ...
    def added_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str):
        data = MultipartEncoder(
            fields={
                'pet_photo': (pet_photo, open(pet_photo, 'rb'), 'jpeg')
            })
